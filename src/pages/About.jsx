  ...
  const content = [
    {
      ...
      content: <img src="/mission.png" alt="Our Mission" className="h-full w-full " />,
    },
    {
      title: "Our Vision",
      description: "To create innovative solutions that empower businesses and individuals worldwide.",
      content: <img src="/vision.png" alt="Our Vision" className="h-full w-full " />,
    },
    {
      title: "Our Journey",
      ...
      content: <img src="/journey.png" alt="Our Journey" className="h-full w-full " />,
    },
    {
      title: "",
      description: ""
