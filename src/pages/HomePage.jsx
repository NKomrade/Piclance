  ...
  return (
    <div>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center flex-grow relative z-10 min-h-screen animate-fade-in">
          <div className="bg-black bg-opacity-50 p-8 rounded-md max-w-5xl w-full text-center mx-4 md:mx-0 animate-float">
            <h1 className="text-5xl md:text-6xl font-extrabold mb-4">OUR SERVICES</h1>
        ...
        <div className="flex flex-col items-center relative z-10 pb-10">
          {/* Video Editing Card */}
          <div className="flex items-center bg-black bg-opacity-50 p-6 rounded-lg max-w-4xl w-full text-gray-200 shadow-lg text-left mt-4 animate-float">
            <img src="/image-1.jpg" alt="Video Editing" className="w-24 h-24 mr-4 rounded-md object-cover" />
            <div>
          ...
          {/* Photo Editing Card */}
          <div className="flex items-center bg-black bg-opacity-50 p-6 rounded-lg max-w-4xl w-full text-gray-200 shadow-lg text-left mt-4 animate-float">
            <img src="/image-2.jpg" alt="Photo Editing" className="w-24 h-24 mr-4 rounded-md object-cover" />
            <div>
          ...
          <div className="flex items-center bg-black bg-opacity-50 p-6 rounded-lg max-w-4xl w-full text-gray-200 shadow-lg text-left mt-4 animate-float">
            <img src="/image-5.jpg" alt="Social Media Management" className="w-24 h-24 mr-4 rounded-md object-cover" />
            <div>
              <h2 className="text-2xl font-bold mb-2">SOCIAL MEDIA MANAGEMENT</h2>
              <p>
